 ...
 */
public class videoForWord {



        private static String mencoder_home = "D:\\javaserve\\mencoder\\mencoder.exe";//mencoder.exe所放的路径
        private static String ffmpeg_home = "D:\\ffmpeg-20170724-03a9e6f-win64-static\\bin\\ffmpeg.exe";//ffmpeg.exe所放的路径
         ...
         */
        @Test
        public  void processFLV() {
            String inputFile="F:\\ftpfIle\\move\\神奇的中医.mp4";
            String outputFile="F:\\ftpfIle\\move\\test.264";
            /*if (!checkfile(inputFile)) {
                System.out.println(inputFile + " is not file");
                return false;
            }*/
            ...
            /*if(file.exists()){
               ...
               *//* return true;*//*
                ...
                try {
                    ...
                    builder.command("D:\\ffmpeg-20170724-03a9e6f-win64-static\\bin\\ffmpeg.exe" +
                            " –i F:\\ftpfIle\\move\\神奇的中医.mp4 -vcodec mpeg4 –vtag xvid –qsame F:\\ftpfIle\\move\\test.avi ");
                    builder.start();
                    //return true;
                } catch (Exception e) {
                    e.printStackTrace();
       ...
       /* }*/
        ...
        public  void test(){
            ...
            commend.add(ffmpeg_home);
            commend.add("-i");
            commend.add("F:\\ftpfIle\\move\\神奇的中医.mp4");
            commend.add("-ab");
            commend.add("128");
            commend.add("-acodec");
            commend.add("libmp3lame");
